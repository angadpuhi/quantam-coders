  ...
  return (
    <div className="max-w-xl mx-auto py-16 px-4 text-center">
      <div className="bg-white border border-kerala-coir-200 rounded-houseboat p-8 shadow-sm relative overflow-hidden">
        ...
        <h2 className="text-lg font-bold text-slate-800 mt-1">Page or Record Not Found</h2>

        <p className="text-xs text-slate-600 mt-2 leading-relaxed max-w-md mx-auto">
          The requested health record, worker profile, or clinical portal page could not be located in the Kerala MigrantHealth registry.
        </p>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          ...
          >
            ...
            <span>Search Worker Registry</span>
          </Link>
        </div>
      </div>
    </div>
